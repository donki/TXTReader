...
Este template es de uso libre. Puedes modificarlo y adaptarlo según tus necesidades. Se recomienda mantener la estructura base para consistencia visual.

---

**Versión del Template**: 1.0  
**Compatibilidad**: .NET MAUI 7.0+  
